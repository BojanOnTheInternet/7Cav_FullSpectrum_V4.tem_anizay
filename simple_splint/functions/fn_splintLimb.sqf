...
[_splint_time, [_hitPoint, _selectionNumbers, _player, _target], simple_splint_fnc_fixLimb, {_player switchMove "AmovPknlMstpSrasWrflDnon"}, "Applying SAM Splint"] call ace_common_fnc_progressBar;
