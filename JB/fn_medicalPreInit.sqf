...
#define MEDICAL_ACTION_DISTANCE 3
...
[
	...
	["Yes, man is mortal, but that would be only half the trouble. The worst of it is that he's sometimes unexpectedly mortal\97there's the trick!", "Mikhail Bulgakov, The Master and Margarita"],
	...
	["To die trying is the proudest human thing.", "Robert A. Heinlein, Have Space Suit\97Will Travel"],
...
JBM_GetMortalityQuote =
{
	...
	format ["<t size='1.4'>\93%1\94</t><br/><br/><t color='#AAAAAA'>--%2</t>", _quote select 0, _quote select 1]
};
